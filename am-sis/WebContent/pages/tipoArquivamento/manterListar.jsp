...
<body>
	<section id="head" class="container">
		...
		<h3 class="text-muted">
			Am-Sis <small>Tipo de arquivamento</small>
		</h3>
	</section>
	...
	<section class="container">
		<table class="table">
			<caption>Listagem de Tipos Arquivos</caption>
			<thead>
				<tr>
					<th>Descrição</th>
				</tr>
			</thead>
			<tbody id="listaArquivamentos">
			</tbody>
		</table>
	</section>
</body>
<script src="../../js/am-sis.js?v=<%=Recursos.getProperties().getProperty("versao")%>"></script>
<script src="tipoArquivamento.js?v=<%=Recursos.getProperties().getProperty("versao")%>"></script>
</html>
