...
<body>
	<table>
		<thead>
			<tr>
				<th colspan="2" align="left" class="info-header">Am-Sis
		...
		<tbody>
			...
			<tr>
				...
				<td class="c2"><%=Locale.getDefault()%> / <%=TimeZone.getDefault().getDisplayName(Locale.getDefault())%> (<%=(TimeZone.getDefault().getRawOffset() / 1000 / 60 / 60)%>
					GMT)</td>
			</tr>
			<tr>
